...
- `workloads/dependency-track-secrets`: Secret objects used by Dependency-Track and PostgreSQL.
...
- Replace placeholder values in `workloads/dependency-track-secrets/secret-db.yaml` for your environment.
